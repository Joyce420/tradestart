  ...
  const roadmapNodes = [
    ...
    },
    {
      ...
      playbook: [
        ...
        { title: "用计算器试三个售价", body: "不要只算一个价格。分别试保守价、目标价和高价，观察单件利润、总利润和运费占比。", action: "打开计算器时会自动带入你在节点 2 填写的采购价和 MOQ；再补齐售价、物流和其他成本。", links: [["带入数据并打开利润计算器", "calculator.html?from=roadmap"]] },
